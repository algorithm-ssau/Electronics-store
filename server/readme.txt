...
Подготовка к запуску PythonAPI:
    1) Запустить в терминале команду python -m venv env
    2) Активировать виртуальную среду разработки вводом в терминал команды source env/scripts/activate
    3) Запустить в терминале команду pip install -r pip_packages.txt
Запуск Python API:
